 ...
 */
export declare type GradleArgTask = "bundle" | "assemble" | "test" | "clean";
export declare type GradleArgs = {
    /**
...
export declare function gradle(task: GradleArgTask, args?: GradleArgs): AndroidLane;
